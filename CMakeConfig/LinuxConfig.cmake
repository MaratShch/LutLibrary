...
if (ENABLE_HIGH_ACCURACY)
 ...
 set(CMAKE_CXX_FLAGS_MINSIZEREL "-O2" CACHE STRING "-O2" FORCE)
 ...
 add_compile_options(
    ...
    "$<$<CONFIG:RELEASE>:-O2 -s -DNDEBUG>"		 # high optimization
    "$<$<CONFIG:RelWithDebInfo>:-O2 -ggdb -g -DNDEBUG>"
 ...
 set(CMAKE_CXX_FLAGS_DEBUG "-O0" CACHE STRING "-O0" FORCE)
 set(CMAKE_CXX_FLAGS_RELEASE "-O2" CACHE STRING "-O3" FORCE)
 set(CMAKE_CXX_FLAGS_MINSIZEREL "-O2" CACHE STRING "-O3" FORCE)
 set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-Os" CACHE STRING "-Os" FORCE)
